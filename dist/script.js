    ...
    value: function checkMailInputs(selector) {
      ...
      mailInputs.forEach(function (input) {
        input.addEventListener('keypress', function (e) {
          // маска запрещает ввод кириллицы
      ...
      this.btns.forEach(function (btn, i) {
        ...
        btn.addEventListener('click', function () {
          if (!btn.closest('.module__video-item') || btn.closest('.module__video-item').getAttribute('data-disabled') !== 'true') {
            _this.activeBtn = btn; // console.log('Hello');
...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    value: function showSlides(n) {
      ...
      this.slides[this.slideIndex - 1].style.display = 'block'; // console.log(this.slides[this.slideIndex - 1]);
    }
  }, {
    key: "plusSlides",
